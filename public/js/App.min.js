 ...
 * of patent rights can be found in the PATENTS file in the same directory.
 *
 */!function(e){if("object"==(typeof exports==="undefined"?"undefined":_typeof(exports))&&"undefined"!=typeof module)module.exports=e(require("react"));else if("function"==typeof define&&define.amd)define(["react"],e);else{var f;f="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this,f.ReactDOM=e(f.React);}}(function(e){return e.__SECRET_DOM_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;});var Content=function(_React$Component){_inherits(Content,_React$Component);function Content(props){_classCallCheck(this,Content);return _possibleConstructorReturn(this,(Content.__proto__||Object.getPrototypeOf(Content)).call(this,props));}_createClass(Content,[{key:"render",value:function render(){return React.createElement("div",{className:"tab-content"},this.props.components);}}]);return Content;}(React.Component);Content.propTypes={divClass:React.PropTypes.string,components:React.PropTypes.element.isRequired};var Header=function(_React$Component2){_inherits(Header,_React$Component2);function Header(props){_classCallCheck(this,Header);return _possibleConstructorReturn(this,(Header.__proto__||Object.getPrototypeOf(Header)).call(this,props));}_createClass(Header,[{key:"render",value:function render(){return React.createElement("div",{className:"header"},React.createElement("h1",null,"ek portfolio"));}}]);return Header;}(React.Component);;var SubHeader=function(_React$Component3){_inherits(SubHeader,_React$Component3);function SubHeader(props){_classCallCheck(this,SubHeader);return _possibleConstructorReturn(this,(SubHeader.__proto__||Object.getPrototypeOf(SubHeader)).call(this,props));}_createClass(SubHeader,[{key:"render",value:function render(){return React.createElement("div",{className:"sub-header "+this.props.divClass},React.createElement("img",{src:this.props.iconsrc,alt:this.props.iconalt,className:"sub-header-icon"}),React.createElement("h2",null,this.props.subtitle));}}]);return SubHeader;}(React.Component);var Tab=function(_React$Component4){_inherits(Tab,_React$Component4);function Tab(props){_classCallCheck(this,Tab);return _possibleConstructorReturn(this,(Tab.__proto__||Object.getPrototypeOf(Tab)).call(this,props));}_createClass(Tab,[{key:"render",value:function render(){return React.createElement("div",{className:"tab"},React.createElement(Content,{components:this.props.content,divClass:"tab-content"}));}}]);return Tab;}(React.Component);Tab.propTypes={label:React.PropTypes.string,content:React.PropTypes.element,index:React.PropTypes.number};// <h2 className="tab-label">{this.props.title != undefined ? this.props.title : this.props.label}</h2>
var TabsAccordion=function(_React$Component5){_inherits(TabsAccordion,_React$Component5);function TabsAccordion(props){_classCallCheck(this,TabsAccordion);var _this5=_possibleConstructorReturn(this,(TabsAccordion.__proto__||Object.getPrototypeOf(TabsAccordion)).call(this,props));_this5.state={openTab:0,nextBtn:true,prevBtn:false,lastTabIndex:_this5.props.tabs.length-1};return _this5;}_createClass(TabsAccordion,[{key:"incrementTab",value:function incrementTab(){this.goToTab(this.state.openTab+1);}},{key:"decrementTab",value:function decrementTab(){this.goToTab(this.state.openTab-1);}},{key:"goToTab",value:function goToTab(num){this.setState({openTab:num,nextBtn:this.state.lastTabIndex==num?false:true,prevBtn:num==0?false:true});}},{key:"render",value:function render(){var _this6=this;var navBtns=this.props.tabs.map(function(btn){return React.createElement("button",{type:"button",className:_this6.state.openTab==btn.props.index?"tab-nav disabled":"tab-nav",onClick:function onClick(){return _this6.goToTab(btn.props.index);}},btn.props.label);});return React.createElement("div",{className:"tabs-accordion"},navBtns,this.props.tabs[this.state.openTab],React.createElement("button",{type:"button",className:this.state.prevBtn?"prev-tab-btn":"prev-tab-btn disabled",onClick:function onClick(){return _this6.decrementTab();}},"Previous"),React.createElement("button",{type:"button",className:this.state.nextBtn?"next-tab-btn":"next-tab-btn disabled",onClick:function onClick(){return _this6.incrementTab();}},"Next"));}}]);return TabsAccordion;}(React.Component);TabsAccordion.propTypes={tabs:React.PropTypes.arrayOf(React.PropTypes.element).isRequired};// ***** CONVERT OBJECT TO ARRAY ***** //
function toArray(obj){var result=[];Object.keys(obj).forEach(function(key){result.push(obj[key]);});return result;}// ***** CONVERT KEYS AND VALUES TO OBJECT ***** //
function toObject(keys,values){result={};for(var i=0;i<keys.length;i++){result[keys[i]]=values[i];}return result;}// ***** DEFINE WHETHER A NUMBER IS BETWEEN A SPECIFIED MINIMUM AND MAXIMUM ***** //
...
Number.prototype.between=function(min,max){return this>min&&this<max;};// ***** PAD AN INTEGER CONVERTED TO STRING WITH A SPECIFIED NUMBER OF LEADING zeros ***** //
Number.prototype.pad=function(num){var str=String(this);while(str.length<(num||2)){str="0"+str;}return str;};// ***** REFORMAT DATE STRING IN YYYY-MM-DD ***** //
Date.prototype.yyyymmdd=function(){var mm=this.getMonth()+1;var dd=this.getDate();if(mm<=9){mm=mm.pad();}if(dd<=9){dd=dd.pad();}return[this.getFullYear(),mm,dd].join('-');};// ***** REFORMAT DATE STRING IN DD-MM-YYYY ***** //
Date.prototype.ddmmyyyy=function(){var mm=this.getMonth()+1;var dd=this.getDate();if(mm<=9){mm=mm.pad();}if(dd<=9){dd=dd.pad();}return[dd,mm,this.getFullYear()].join('-');};// ***** SEARCH FOR EXISTENCE OF ITEM INSIDE NESTED ARRAY ***** //
// for the search of an item inside of an array of arrays
// return true if item is found, false if item is not found
function searchInNestedArray(haystack,needle){for(i=0;i<haystack.length;i++){for(j=0;j<haystack[i].length;j++){if(haystack[i][j]==needle){return true;}else{continue;}}}return false;}// ***** SEARCH FOR INDEX OF ITEM INSIDE NESTED ARRAY ***** //
// for the search of an item inside of an array of arrays
// return index if item is found, -1 if item is not found
function searchInNestedArrayIndex(haystack,needle){for(i=0;i<haystack.length;i++){for(j=0;j<haystack[i].length;j++){if(haystack[i][j]==needle){return i;}else{continue;}}}return-1;}// ***** MANIPULATE STRING TO TITLE CASE ***** //
// returns a string with the first letter of each word in uppercase format
function toTitleCase(str){return str.replace(/\w\S*/g,function(txt){return txt.charAt(0).toUpperCase()+txt.substr(1).toLowerCase();});}// ***** MANIPULATE URL ENCODED STRING TO JS OBJECT (DEPARAM) ***** //
// NOT MINE, EXTRACTED FROM OPEN SOURCE PLUGIN
/*
  jQuery deparam is an extraction of the deparam method from Ben Alman's jQuery BBQ
  http://benalman.com/projects/jquery-bbq-plugin/
*/(function($){$.deparam=function(params,coerce){var obj={},coerce_types={'true':!0,'false':!1,'null':null};// Iterate over all name=value pairs.
$.each(params.replace(/\+/g,' ').split('&'),function(j,v){var param=v.split('='),key=decodeURIComponent(param[0]),val,cur=obj,i=0,// If key is more complex than 'foo', like 'a[]' or 'a[b][c]', split it
...
if(param.length===2){val=decodeURIComponent(param[1]);// Coerce values.
...
obj[key]=coerce?undefined:'';}});return obj;};})(jQuery);// COUNT ITEMS IN AN OBJECT
Object.size=function(obj){var size=0,key;for(key in obj){if(obj.hasOwnProperty(key))size++;}return size;};// GET SINGLE OBJECT KEY-VALUE PAIRS
...
function objectArrayValueToStringValue(obj){var newObj={};Object.keys(obj).forEach(function(key){if(obj[key]instanceof Array){var i=obj[key].length-1;newObj[key]=obj[key][i];}else if(typeof obj[key]=='string'){newObj[key]=obj[key];}else{console.log('ERROR:  Invalid object value type.  Type: ',_typeof(obj[key]));}});return newObj;}// CREATE A SEQUENTIAL PROMISE
function sequentialPromise(functionsArr){if(functionsArr instanceof Array){}else{console.log('ERROR:  Array of minimum two functions not present in sequentialPromise() parameters');}}// REMOVE SPACES FROM STRING
function removeSpacesFromString(str){return str.replace(/\s+/g,'');}// GET COMPONENT DATA
function getComponentData(name){name=name.toString();// console.log('name: ', name)
// console.log('saved data: ', formAnswersObj[name])
return formAnswersObj!=undefined?formAnswersObj.hasOwnProperty(name)?formAnswersObj[name]:null:null;}var App=function(_React$Component6){_inherits(App,_React$Component6);function App(){_classCallCheck(this,App);return _possibleConstructorReturn(this,(App.__proto__||Object.getPrototypeOf(App)).apply(this,arguments));}_createClass(App,[{key:"render",value:function render(){return React.createElement("div",{className:"global-wrapper"},React.createElement(Header,null),React.createElement(TabsAccordion,{tabs:[React.createElement(Tab,{index:0,label:"Experience",content:React.createElement("div",{className:"tab-content-wrapper"},React.createElement(SubHeader,{subtitle:"Experience",divClass:"experience-area-header",iconsrc:"img/placeholder.png",iconalt:"icon placeholder"}))}),React.createElement(Tab,{index:1,label:"Playground",content:React.createElement("div",{className:"tab-content-wrapper"},React.createElement(SubHeader,{subtitle:"Playground",divClass:"playground-area-header",iconsrc:"img/placeholder.png",iconalt:"icon placeholder"}))}),React.createElement(Tab,{index:2,label:"About",content:React.createElement("div",{className:"tab-content-wrapper"},React.createElement(SubHeader,{subtitle:"About",divClass:"about-area-header",iconsrc:"img/placeholder.png",iconalt:"icon placeholder"}))})]}));}}]);return App;}(React.Component);;ReactDOM.render(React.createElement(App,null),document.getElementById('app'));