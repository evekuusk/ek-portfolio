 ...
 * of patent rights can be found in the PATENTS file in the same directory.
 *
 */!function(e){if("object"==(typeof exports==="undefined"?"undefined":_typeof(exports))&&"undefined"!=typeof module)module.exports=e(require("react"));else if("function"==typeof define&&define.amd)define(["react"],e);else{var f;f="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this,f.ReactDOM=e(f.React);}}(function(e){return e.__SECRET_DOM_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;});var Content=function(_React$Component){_inherits(Content,_React$Component);function Content(props){_classCallCheck(this,Content);return _possibleConstructorReturn(this,(Content.__proto__||Object.getPrototypeOf(Content)).call(this,props));}_createClass(Content,[{key:"render",value:function render(){return React.createElement("div",{className:"tab-content"},this.props.components);}}]);return Content;}(React.Component);Content.propTypes={divClass:React.PropTypes.string,components:React.PropTypes.element.isRequired};var Header=function(_React$Component2){_inherits(Header,_React$Component2);function Header(props){_classCallCheck(this,Header);return _possibleConstructorReturn(this,(Header.__proto__||Object.getPrototypeOf(Header)).call(this,props));}_createClass(Header,[{key:"render",value:function render(){return React.createElement("div",{className:"header"},React.createElement("h1",null,"eve kuusk portfolio"));}}]);return Header;}(React.Component);;var SubHeader=function(_React$Component3){_inherits(SubHeader,_React$Component3);function SubHeader(props){_classCallCheck(this,SubHeader);return _possibleConstructorReturn(this,(SubHeader.__proto__||Object.getPrototypeOf(SubHeader)).call(this,props));}_createClass(SubHeader,[{key:"render",value:function render(){return React.createElement("div",{className:"sub-header "+this.props.divClass},React.createElement("img",{src:this.props.iconsrc,alt:this.props.iconalt,className:"sub-header-icon"}),React.createElement("h2",null,this.props.subtitle),this.props.description!=null?React.createElement("h5",{className:"sub-header-description"},this.props.description):null);}}]);return SubHeader;}(React.Component);var Tab=function(_React$Component4){_inherits(Tab,_React$Component4);function Tab(props){_classCallCheck(this,Tab);return _possibleConstructorReturn(this,(Tab.__proto__||Object.getPrototypeOf(Tab)).call(this,props));}_createClass(Tab,[{key:"render",value:function render(){return React.createElement("div",{className:"tab"},React.createElement(Content,{components:this.props.content,divClass:"tab-content"}));}}]);return Tab;}(React.Component);Tab.propTypes={label:React.PropTypes.string,content:React.PropTypes.element,index:React.PropTypes.number};// <h2 className="tab-label">{this.props.title != undefined ? this.props.title : this.props.label}</h2>
var TabsAccordion=function(_React$Component5){_inherits(TabsAccordion,_React$Component5);function TabsAccordion(props){_classCallCheck(this,TabsAccordion);var _this5=_possibleConstructorReturn(this,(TabsAccordion.__proto__||Object.getPrototypeOf(TabsAccordion)).call(this,props));_this5.state={openTab:0,nextBtn:true,prevBtn:false,lastTabIndex:_this5.props.tabs.length-1};return _this5;}_createClass(TabsAccordion,[{key:"incrementTab",value:function incrementTab(){this.goToTab(this.state.openTab+1);}},{key:"decrementTab",value:function decrementTab(){this.goToTab(this.state.openTab-1);}},{key:"goToTab",value:function goToTab(num){this.setState({openTab:num,nextBtn:this.state.lastTabIndex==num?false:true,prevBtn:num==0?false:true});}},{key:"render",value:function render(){var _this6=this;var navBtns=this.props.tabs.map(function(btn){return React.createElement("button",{type:"button",className:_this6.state.openTab==btn.props.index?"tab-nav disabled":"tab-nav",onClick:function onClick(){return _this6.goToTab(btn.props.index);}},btn.props.label);});return React.createElement("div",{className:"tabs-accordion"},React.createElement("div",{className:"tab-nav-btns"},navBtns),this.props.tabs[this.state.openTab],React.createElement("div",{className:"nav-btns"},React.createElement("button",{type:"button",className:this.state.prevBtn?"prev-tab-btn":"prev-tab-btn disabled",onClick:function onClick(){return _this6.decrementTab();}},"Previous"),React.createElement("button",{type:"button",className:this.state.nextBtn?"next-tab-btn":"next-tab-btn disabled",onClick:function onClick(){return _this6.incrementTab();}},"Next")));}}]);return TabsAccordion;}(React.Component);TabsAccordion.propTypes={tabs:React.PropTypes.arrayOf(React.PropTypes.element).isRequired};var AboutContent=function(_React$Component6){_inherits(AboutContent,_React$Component6);function AboutContent(props){_classCallCheck(this,AboutContent);return _possibleConstructorReturn(this,(AboutContent.__proto__||Object.getPrototypeOf(AboutContent)).call(this,props));}_createClass(AboutContent,[{key:"render",value:function render(){return React.createElement("div",{className:"about-content"},React.createElement("p",null,"This is the About content section"));}}]);return AboutContent;}(React.Component);;var ExperienceContent=function(_React$Component7){_inherits(ExperienceContent,_React$Component7);function ExperienceContent(props){_classCallCheck(this,ExperienceContent);return _possibleConstructorReturn(this,(ExperienceContent.__proto__||Object.getPrototypeOf(ExperienceContent)).call(this,props));}_createClass(ExperienceContent,[{key:"render",value:function render(){return React.createElement("div",{className:"experience-content"},React.createElement("p",null,"This is the Experience content section"));}}]);return ExperienceContent;}(React.Component);;var PlaygroundContent=function(_React$Component8){_inherits(PlaygroundContent,_React$Component8);function PlaygroundContent(props){_classCallCheck(this,PlaygroundContent);return _possibleConstructorReturn(this,(PlaygroundContent.__proto__||Object.getPrototypeOf(PlaygroundContent)).call(this,props));}_createClass(PlaygroundContent,[{key:"render",value:function render(){return React.createElement("div",{className:"playground-content"},React.createElement("p",null,"This is the Playground content section"));}}]);return PlaygroundContent;}(React.Component);;// // ***** CONVERT OBJECT TO ARRAY ***** //
...
function monthDiff(d1){var d2=new Date();var months;months=(d2.getFullYear()-d1.getFullYear())*12;months-=d1.getMonth()+1;months+=d2.getMonth();return months<=0?0:months;}function getTimeline(monthDiff){var years=Math.floor(monthDiff/12);var months=monthDiff%12;var phrase="";if(months>0){if(years==1){phrase=years+" Year "+months+" Months";}else{phrase=years+" Years "+months+" Months";}}else{phrase=years+" Years";}return phrase;}//
...
// }
var App=function(_React$Component9){_inherits(App,_React$Component9);function App(props){_classCallCheck(this,App);var _this10=_possibleConstructorReturn(this,(App.__proto__||Object.getPrototypeOf(App)).call(this,props));_this10.state={sectionData:{}};return _this10;}_createClass(App,[{key:"componentDidMount",// getSectionData(name) {
//   name = name.toString().split(' ').join('_')
//   return formAnswersObj != undefined ? formAnswersObj.hasOwnProperty(name) ? formAnswersObj[name] : null : null
// };
value:function componentDidMount(){var _this11=this;fetch("data/section-data.json").then(function(response){return response.json();}).then(function(json){console.log(json);console.log(new Date(json['EXPERIENCE']["positions"][0]['start']));console.log(getTimeline(monthDiff(new Date(json['EXPERIENCE']["positions"][0]['start']))));_this11.setState({aboutData:json["ABOUT"],experienceData:json["EXPERIENCE"],playgroundData:json["PLAYGROUND"]});});}},{key:"render",value:function render(){return React.createElement("div",{className:"global-wrapper"},React.createElement(Header,null),React.createElement(TabsAccordion,{tabs:[React.createElement(Tab,{index:0,label:"Experience",content:React.createElement("div",{className:"tab-content-wrapper"},React.createElement(SubHeader,{subtitle:"Professional Experience",divClass:"experience-area-header",iconsrc:"img/placeholder.png",iconalt:"icon placeholder"}),React.createElement(ExperienceContent,null))}),React.createElement(Tab,{index:1,label:"Playground",content:React.createElement("div",{className:"tab-content-wrapper"},React.createElement(SubHeader,{subtitle:"Playground",divClass:"playground-area-header",iconsrc:"img/placeholder.png",description:"Directory of Mini Example Projects",iconalt:"icon placeholder"}),React.createElement(PlaygroundContent,null))}),React.createElement(Tab,{index:2,label:"About & Contact",content:React.createElement("div",{className:"tab-content-wrapper"},React.createElement(SubHeader,{subtitle:"About & Contact",divClass:"about-area-header",iconsrc:"img/placeholder.png",iconalt:"icon placeholder"}),React.createElement(AboutContent,null))})]}));}}]);return App;}(React.Component);;ReactDOM.render(React.createElement(App,null),document.getElementById('app'));